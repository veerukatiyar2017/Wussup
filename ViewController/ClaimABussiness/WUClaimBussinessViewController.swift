...
//            let cell = self.tableviewClaimBusiness.cellForRow(at: <#T##IndexPath#>)
            Utill.setPlaceHolderTextAndColor(textfield: self.currenttextField,
                                             placeHolderString: Text.Message.msg_CAB_AddressLine1,
                                             placeHolderTextColor: .CABOrangeColor)
            
        } else if self.dicClaimBusiness[Text.DictKeys.city]?.isEmpty == true {
            Utill.setPlaceHolderTextAndColor(textfield: self.currenttextField,
                                             placeHolderString: Text.Message.msg_CAB_City,
                                             placeHolderTextColor: .CABOrangeColor)
            
        } else if self.dicClaimBusiness[Text.DictKeys.zipCode]?.isEmpty == true {
            Utill.setPlaceHolderTextAndColor(textfield: self.currenttextField,
                                             placeHolderString: Text.Message.msg_CAB_StateZip,
                                             placeHolderTextColor: .CABOrangeColor)
            
        } else if self.dicClaimBusiness[Text.DictKeys.phoneNumber]?.isEmpty == true {
            Utill.setPlaceHolderTextAndColor(textfield: self.currenttextField,
                                             placeHolderString: Text.Message.msg_CAB_PhoneNumber,
                                             placeHolderTextColor: .CABOrangeColor)
            
        } else if self.dicClaimBusiness[Text.DictKeys.businessEmail]?.isEmpty == true {
            Utill.setPlaceHolderTextAndColor(textfield: self.currenttextField,
                                             placeHolderString: Text.Message.msg_CAB_Email,
                                             placeHolderTextColor: .CABOrangeColor)
