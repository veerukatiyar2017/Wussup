...
//        var eventEndDate : String = ""
        ...
        WEB_API.call_api_GetShareLinkForVenueOrEvent(strVenueID: venueID,
                                                     strFourSquareVenueID : FourSquareVenueID,
                                                     strEventID: EventID, strLiveCamID: "") { (response, success, message) in
            if success == true{
                ...
                let shareAll : [Any] = [WUShareActivityItemProvider(placeholderItem: shareText ?? Text.Message.msg_Deeplinking_Share) as Any,
                                        WUShareActivityItemProvider(placeholderItem: shareLink ?? "https://apps.arvzapp.com") as Any,
                                        WUShareActivityItemProvider(placeholderItem:name_Venue_Event) as Any,
                                        WUShareActivityItemProvider(placeholderItem:eventStartDate) as Any]
