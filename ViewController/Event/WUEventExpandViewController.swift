...
class WUEventExpandViewController: UIViewController {
    ...
    //MARK: - Variables
    typealias EventListSection  = EventListData.EventListSection
    ...
    var arrEventList            : [WUDateWiseEvents] = []{
        didSet {
            ...
            if selectedCalenderDate.isFriday() && self.arrEventList[EventListSection.thisWeekEvents.rawValue].Events.count != 0{
                self.arrEventList[EventListSection.tomorrowEvents.rawValue].Events += self.arrEventList[EventListSection.thisWeekEvents.rawValue].Events
                self.arrEventList[EventListSection.thisWeekEvents.rawValue].Events.removeAll()
            }
    ...
    private func initialInterfaceSetUp()
    {
        ...
        self.tableViewEvent.register(UINib.init(nibName: Utill.getClassNameFor(classType: WUNoEventTableCell()), bundle: nil),
                                     forCellReuseIdentifier: Utill.getClassNameFor(classType: WUNoEventTableCell()))
...
extension WUEventExpandViewController : UITableViewDataSource ,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        ...
        if section == EventListSection.todayEvents.rawValue
        {
       ...
       /* else if section == EventListSection.tomorrowEvents.rawValue {
            if self.selectedCalenderDate.isWeekendDays() || Date().isFriday(){
                return 1
            }
        }
        */
            
        else if section == EventListSection.thisWeekEvents.rawValue {
            if self.selectedCalenderDate.isFriday() ||  self.selectedCalenderDate.isWeekendDays() || Date().isFriday(){
                return 1
            }
        }
        return 40.0
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView?
    {
        ...
        switch section {
        case EventListSection.todayEvents.rawValue:
            if self.selectedCalenderDate.isToday() {
        ...
        case EventListSection.tomorrowEvents.rawValue:
        ...
        case EventListSection.thisWeekEvents.rawValue:
            if self.selectedCalenderDate.isFriday(){
               return nil
            }else if self.selectedCalenderDate.isToday(){
                if self.selectedCalenderDate.isInThisWeek(){
        ...
        case EventListSection.upComingEvents.rawValue:
            if self.selectedCalenderDate.isToday() || self.selectedCalenderDate.isFriday(){
        ...
        case EventListSection.moreEvents.rawValue:
