...
//
//  WULiveCamRecentSearchViewController.swift
//  Wussup
//
...
// MARK: - Delegate
protocol WULiveCamRecentSearchViewControllerDelegate : class {
    func didSelectRecentSearch(selectedData : String)
}
extension WULiveCamRecentSearchViewControllerDelegate {
    func didSelectRecentSearch(selectedData : String){
        
    }
}

class WULiveCamRecentSearchViewController: UIViewController {
    ...
    var homeSearchVC : WULiveCamSearchViewController!
    weak var delegate : WULiveCamRecentSearchViewControllerDelegate?
...
//MARK: - TableView
extension WULiveCamRecentSearchViewController : UITableViewDelegate , UITableViewDataSource {
...
extension WULiveCamRecentSearchViewController : WULiveCamSearchViewControllerDelegate {
