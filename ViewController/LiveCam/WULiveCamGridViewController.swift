...
class WULiveCamGridViewController: UIViewController {
    ...
    private func prepareViewForTableviewHeader(){
        ...
        self.imageViewIcon.sd_setImage(with: URL(string: self.arrCollectionDataCopy[0].ImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: [SDWebImageOptions.cacheMemoryOnly])
