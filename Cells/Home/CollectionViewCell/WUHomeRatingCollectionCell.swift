...
//        }
    ...
    private func setCellDetail() {
        ...
        if coverImage.count > 0 {
            self.imageViewRating.sd_setImage(with: URL(string: coverImage[0].SquareImage), placeholderImage:#imageLiteral(resourceName: "NullState_CoverPhoto") , options: [SDWebImageOptions.cacheMemoryOnly])
        }else {
