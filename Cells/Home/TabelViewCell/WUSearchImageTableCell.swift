...
class WUSearchImageTableCell: UITableViewCell {
    ...
    private func setCellDetail(){
        ...
        self.imageViewCategoryIcon.sd_setImage(with: URL(string: category.UnSelectedImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: [SDWebImageOptions.cacheMemoryOnly])
    }
