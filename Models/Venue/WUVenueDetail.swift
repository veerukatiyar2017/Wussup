...
class WUVenueDetail: NSObject,Decodable,Copying {
    ...
    var VenueFeaturedImageType: String              = ""
    ...
    required init(original: WUVenueDetail) {        self.IsUserFavoriteVenue = original.IsUserFavoriteVenue
        ...
        self.VenueFeaturedImageType = original.VenueFeaturedImageType
    }
    ...
    required init(from decoder: Decoder) throws
    {
        ...
        do {
            if let Radius = try values.decodeIfPresent(String.self, forKey: .Radius){
                self.Radius = Radius
            }
        } catch DecodingError.typeMismatch {
            
            Utill.printInTOConsole(printData:"solved type mismatched in WUVenueDetail for Radius ")
        }
        ...
        do {
            if let VenueFeaturedImageType = try values.decodeIfPresent(String.self, forKey: .VenueFeaturedImageType){
                self.VenueFeaturedImageType = VenueFeaturedImageType
            }
        } catch DecodingError.typeMismatch {
                Utill.printInTOConsole(printData:"type mismatched in WUVenueDetail for VenueFeaturedImageType ")
        }
    }
}
//
extension WUVenueDetail: Encodable
{
    func encode(to encoder: Encoder) throws
    {
        ...
        try container.encode(VenueFeaturedImageType, forKey: .VenueFeaturedImageType)
