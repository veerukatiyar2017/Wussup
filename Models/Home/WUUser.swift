...
class WUUser: NSObject, Decodable {
    ...
    var CategoriesPreference  : [WUCategory] = []
    ...
    required init(from decoder: Decoder) throws {
        ...
        do {
            if let UID = try values.decodeIfPresent(String.self, forKey: .UserUID) {
                self.UID = UID
            }
        } catch DecodingError.typeMismatch {
            Utill.printInTOConsole(printData:"solved type mismatched in WUUser for UID ")
        }
        ...
        do {
            if let categoriesPreference = try values.decodeIfPresent(Array<WUCategory>.self, forKey: .CategoriesPreference){
                self.CategoriesPreference = categoriesPreference
            }
        } catch DecodingError.typeMismatch {
            // There was something for the "manage_stock" key, but it wasn't a boolean value. Try a string.
            Utill.printInTOConsole(printData:"type mismatched in WUUser for CategoriesPreference ")
        }
        do {
        ...
        do {
            if let PostalCode = try values.decodeIfPresent(String.self, forKey: .PostalCode){
                self.PostalCode = PostalCode
            }
        } catch DecodingError.typeMismatch {
                Utill.printInTOConsole(printData:"type mismatched in WUUser for PostalCode ")
        }
    }
}
...
extension WUUser: Encodable{
    ...
    func encode(to encoder: Encoder) throws{
        ...
        try container.encode(UID, forKey: .UserUID)
        ...
        try container.encode(CategoriesPreference, forKey: .CategoriesPreference)
