...
//        self.imageViewCategoryIcon.sd_setIndicatorStyle(.white)
        ...
        if profileCategory is WUVenueProfilePhotos {
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: photos.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: promotion.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: specials.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: liveCams.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: happyHours.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: menus.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: liveMusic.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: specialEvents.CategoryImage), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: eventPhoto.ImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: eventPromoter.ImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: moreEvent.ImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: eventDirection.ImageURL), placeholderImage:#imageLiteral(resourceName: "DirectionIcon") , options: .refreshCached)
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: ""), placeholderImage:#imageLiteral(resourceName: "MyEventListIcon") , options: .refreshCached)
        }
            ...
            self.imageViewCategoryIcon.sd_setImage(with: URL(string: admissionDetail.ImageURL), placeholderImage:#imageLiteral(resourceName: "placeholder") , options: .refreshCached)
        }
    }
