...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyBeddIglUPIklnBUaOruhxgdQhxQYNJczs")
        ...
        if launchOptions != nil {
            ...
            {
                //                Utill.showAlertViewOnWindow(message: "URL :\(url)")
                self.redirectUrl = url
            }
        }
       
        //        self.redirectUrl = URL(string: "arvz-sandbox://venue/100/FourSquareID/4c45-ca1636d6a59325556ca8")
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any] = [:]) -> Bool {
        ...
        //            return true
        //        }
        //For Redirect :: DeepLink Step 1
        
        //        #if SANDBOX
        //        if "arvz-sandbox".containsIgnoringCase(find: url.scheme!){
        ////            let finalurl = URL(string: "arvz-sandbox://venue/100/FourSquareID/4c45-ca1636d6a59325556ca8")
        //            if url.host == "venue"{
        ...
        //            } //arvz://event/319
        //https://apps.arvzapp.com/event/319
        //        }
        //        #else
        //       arvz://event/163
        print("Open URL: \(url)")
    ...
    func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([Any]?) -> Void) -> Bool {
        ...
        if userActivity.activityType == NSUserActivityTypeBrowsingWeb {
            ...
            let urlString = url.absoluteString.replacingOccurrences(of: "https://apps.arvzapp.com/", with: "arvz://")
            url = URL(string: urlString)!
            print("Continue User Activity called With URL: \(url.absoluteString)")
            if "arvzapp".containsIgnoringCase(find: url.scheme!){
                if url.host == "venue"{
                    self.reDirectToVenueProfile(redirectUrl : url)
                }else if url.host == "event"{
    ...
    //        Utill.printInTOConsole(printData:error.localizedDescription)
    //    }
    ...
    private func callWS_GetTotalUnreadNotification(){
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            case .authorizedAlways, .authorizedWhenInUse :
                ...
                DispatchQueue.main.asyncAfter(deadline: deadlineTime) {
                    ...
                    guard let loc = self.locationManager.location?.coordinate else {return}
...
extension AppDelegate : MessagingDelegate {
    ...
    func messaging(_ messaging: Messaging, didReceive remoteMessage: MessagingDelegate) {
        print("userInfo \(remoteMessage.description)")
        //  self.receivedPushNotification(remoteMessage.description)
    }
}
